...
const VideoGallery = () => {
  ...
  return (
    <section className="videos-section reveal py-24 px-4 md:px-8 bg-white border-b border-black/5 relative text-[var(--primary-dark)]">
      <div className="parallax-bg" data-speed="0.05"></div>
      <div className="container text-center mb-16 mx-auto px-4">
      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-[1400px] mx-auto px-4 md:px-0">
        {[
