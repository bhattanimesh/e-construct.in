...
const BimHubMSS = () => {
  ...
  // Authentic Student Reviews Sourced Directly from e-construct.in live website
  const studentReviews = [
    ...
    },
    {
      ...
      rating: 5,
      videoId: '1AehbURvS8k',
      quote: 'Journey of a Civil Engineer — Swapnil Katiyar shares how the 12 Months Training + On-Job Internship built his confidence in real corporate design environments.'
    },
    {
      id: 4,
      name: 'Preethi Prasad',
          ...
          <motion.div {...fin} className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
            <div>
              ...
              <p className="text-gray-500 text-sm max-w-xl mt-2 leading-relaxed">
                Graduate with an industry-grade portfolio containing complete structural calculation reports, ETABS models, and GFC drawing sheets.
              </p>
            </div>
            ...
            <div className="flex w-full h-full transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)]"
              ...
              {sliderImages.map((src, i) => (
                <div key={i} className="w-full h-full flex-shrink-0 relative">
                  <img src={src} alt={`Portfolio Project Slide ${i + 1}`} className="w-full h-full object-cover bg-black" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-8">
                    <div className="text-white">
                      ...
                      <p className="text-sm md:text-base font-medium text-gray-200">
                        Real live project structural design, centerline plans, and GFC drawing documentation created during training.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div>
              ...
              <p className="text-gray-400 text-base max-w-xl mt-2 leading-relaxed">
                Hear directly from our Master Study alumni placed in structural engineering firms across India, UAE, and Muscat.
              </p>
            </div>
      ...
      <section id="enrollment" className="py-16 md:py-24 bg-white border-b border-gray-200">
        <div className="max-w-[1400px] mx-auto px-5 sm:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-14">
            {[
              { step: '01', title: 'Initial Registration', desc: 'Fill out the online application form and register your core engineering details.' },
      ...
      <section id="apply-now" className="py-16 md:py-24 bg-slate-50 border-b border-gray-200">
        <div className="max-w-[1200px] mx-auto px-5 sm:px-10">
          <motion.div {...fin} className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 tracking-tight">
              Structural Engineering <span className="text-yellow-600 italic font-serif">100% Placement Program</span>
            </h2>
          </motion.div>
