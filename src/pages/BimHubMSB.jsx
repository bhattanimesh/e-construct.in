...
const BimHubMSB = () => {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentVideoSlide((prev) => (prev + 1) % reviewVideos.length);
    }, 4500);
    return () => clearInterval(timer);
  }, [reviewVideos.length]);

  const nextVideoSlide = () => setCurrentVideoSlide((prev) => (prev + 1) % reviewVideos.length);
  const prevVideoSlide = () => setCurrentVideoSlide((prev) => (prev - 1 + reviewVideos.length) % reviewVideos.length);
  ...
  const faqs = [
    {
      question: "What is the duration of the Master Study in Project Management with BIM Technology program?",
      answer: "The program duration ranges from 7 to 12 months, designed to thoroughly prepare you until you are successfully placed in the industry."
    },
    {
      question: "What is included in the \"On-job Learning Program\"?",
      answer: "Our On-Job Learning Program provides hands-on, practical experience from Center Line Plan (CLP) to Good for Construction (GFC). You will work on real-time RCC, STEEL, and Composite Structures within a true corporate environment."
    },
    {
      question: "Will I receive a certification upon completing the program?",
      answer: "Yes, upon successful completion of the program, you will receive an industry-recognized certification from Econstruct as well as an official Experience Letter showcasing your practical project work."
    },
    {
      question: "What software tools will I learn during the program?",
      answer: "You will master a comprehensive technological stack including AutoCAD, REVIT Architecture, REVIT Structures, REVIT MEP, Synchro, Navisworks, Infraworks, Primavera, along with over 40 intensive Design Spreadsheets."
    },
    {
      question: "Is there any placement assistance after completing the program?",
      answer: "Absolutely. We provide a 100% placement guarantee. Our dedicated placement cell assists you with resume building, mock interviews, and direct corporate alignment using our world-class CRM system."
    },
    {
      question: "Can I choose the mode of learning for this program?",
      answer: "Yes, we offer highly flexible learning options to suit both students and working professionals. You can choose from entirely Offline (at our Bangalore HQ), Online (self-paced), or our Hybrid modes."
    }
  ];
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col justify-start">
      ...
      <section className="relative w-full h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden mt-20">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center mt-10">
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-medium text-white leading-tight tracking-tight drop-shadow-[0_4px_4px_rgba(0,0,0,0.5)]">
            <span className="accent-text italic">MSB</span>
          </h1>
          <p className="mt-6 text-white text-lg md:text-xl font-medium tracking-wide drop-shadow-md max-w-3xl text-center leading-relaxed">
            MSB Documentation and Insights
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1500px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-[16px] shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-8 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)] border border-gray-100 flex flex-col h-full">
              ...
              <div className="mt-auto pt-6 border-t border-gray-100">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">Batch Start</h3>
                </div>
            ...
            <div className="bg-white rounded-[16px] shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-8 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)] border border-gray-100 flex flex-col h-full">
              ...
              <ul className="text-gray-600 space-y-2 font-medium flex-1 overflow-y-auto">
                {[
                  'AutoCAD',
                  'REVIT Architecture',
                  'REVIT Structures',
      ...
      <section className="bg-slate-50 py-20 px-4 md:px-8 border-t border-gray-200">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="relative group rounded-[16px] overflow-hidden shadow-[0_20px_50px_-15px_rgba(0,0,0,0.2)] bg-white aspect-video md:aspect-[21/9]">
            ...
            {/* Dots */}
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center justify-center gap-3 z-10 bg-black/30 backdrop-blur-md px-6 py-3 rounded-full">
              ...
              <div className="space-y-8 pt-10 border-t border-gray-100">
                ...
                <div className="flex flex-col sm:flex-row gap-8 pt-6">
                  <div className="flex-1">
                    <h4 className="font-extrabold text-gray-900 mb-4 text-xs uppercase tracking-[0.15em] text-gray-400">Offline Meeting</h4>
                    <button className="flex items-center gap-2 text-blue-600 font-bold hover:text-blue-700 transition group">
                      <span className="border-b border-blue-600 border-dashed group-hover:border-solid">View details for Bangalore</span>
                    </button>
                  </div>
                  <div className="flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 items-stretch">
            ...
            <div className="bg-white rounded-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-gray-100 p-8 hover:-translate-y-2 transition-transform duration-300 flex flex-col h-full flex-1">
              ...
              <ul className="space-y-3 text-gray-600 text-sm font-medium leading-relaxed flex-1">
                ...
                <li className="flex items-start gap-2"><span className="text-[#fbc02d] mt-1">•</span>Projects must be submitted weekly or monthly as directed.</li>
                <li className="flex items-start gap-2"><span className="text-[#fbc02d] mt-1">•</span>Attend Doubt Clearing Sessions (DCS) or schedule 1-on-1 Zoom calls.</li>
                <li className="flex items-start gap-2"><span className="text-[#fbc02d] mt-1">•</span>Ask questions via the official chat server or WhatsApp.</li>
                ...
                <li className="flex items-start gap-2"><span className="text-[#fbc02d] mt-1">•</span>Maintain a consistent routine to balance job and training.</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-gray-100 p-8 hover:-translate-y-2 transition-transform duration-300 flex flex-col h-full flex-1">
              ...
              <ul className="space-y-3 text-gray-600 text-sm font-medium leading-relaxed flex-1">
                ...
                <li className="flex items-start gap-2"><span className="text-[#fbc02d] mt-1">•</span>Stay connected via Zoom during working hours (9 am to 7 pm, Mon-Fri) for a work-from-home experience.</li>
                ...
                <li className="flex items-start gap-2"><span className="text-[#fbc02d] mt-1">•</span>Attend dedicated Doubt Clearing Sessions (DCS).</li>
                <li className="flex items-start gap-2"><span className="text-[#fbc02d] mt-1">•</span>Complete and submit assignments online, staying in touch throughout the day.</li>
      ...
      <section className="bg-slate-50 py-24 px-4 md:px-8 border-t border-gray-200">
        <div className="max-w-[1200px] mx-auto">
          <div className="mb-14 text-center">
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-4 tracking-tight">Our Student Reviews</h2>
      ...
      <section className="bg-black py-24 px-4 md:px-0">
        <div className="w-full max-w-[1920px] mx-auto overflow-hidden shadow-2xl relative group">
        ...
        <div className="max-w-[1500px] mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-12 items-start">
            ...
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="bg-slate-900 text-white p-10 rounded-[30px] shadow-[0_15px_40px_rgba(0,0,0,0.2)] relative overflow-hidden group">
                 ...
                 <h3 className="text-2xl md:text-3xl font-black mb-4 leading-snug">
                   ...
                   <span className="text-[#fbc02d]">This is ON-THE-JOB Learning</span> in a real professional setting.
                 </h3>
                 ...
                 <button className="bg-white text-slate-900 font-black px-8 py-4 rounded-xl hover:bg-gray-100 hover:-translate-y-1 transition-all duration-300 uppercase tracking-widest text-sm shadow-[0_10px_20px_rgba(255,255,255,0.1)] w-full sm:w-auto">
                   Welcome Aboard
                 </button>
              </div>
            </div>
          ...
          <div className="bg-white rounded-[32px] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.08)] border border-gray-100 flex flex-col lg:flex-row shadow-xl">
            ...
            <div className="p-8 md:p-14 lg:w-2/3 flex flex-col justify-center">
              ...
              <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-4 leading-tight">
                BIM & Project Management <span className="text-[#fbc02d]">Redefined</span>
              </h2>
              ...
              <ul className="space-y-4 mb-10">
                {[
                  ...
                  "AutoCAD | REVIT Architecture | REVIT Structures | REVIT MEP | Synchro | Navisworks | Infraworks | Primavera",
                  "Digital Library",
      ...
      <section className="bg-white py-24 px-4 md:px-8 border-t border-gray-200">
        <div className="max-w-[1500px] mx-auto">
          <div className="mb-16 text-center">
             <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-4 tracking-tight">Explore Related Programs</h2>
             <div className="w-24 h-[4px] bg-[#fbc02d] mx-auto rounded-full mt-4"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            ...
            <div className="bg-white rounded-[24px] shadow-[0_15px_40px_rgba(0,0,0,0.08)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-2 transition-transform duration-500 h-full">
               <div className="h-60 overflow-hidden relative">
                 <img src="/prj4.jpg" alt="Structural Engineering" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
               ...
               <div className="p-8 flex flex-col flex-1">
                 ...
                 <button className="self-start text-blue-600 font-black uppercase tracking-widest text-sm hover:text-blue-800 transition flex items-center gap-2 group-hover:gap-4 mt-auto">
            ...
            <div className="bg-white rounded-[24px] shadow-[0_15px_40px_rgba(0,0,0,0.08)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-2 transition-transform duration-500 h-full">
               <div className="h-60 overflow-hidden relative">
                 <img src="/prj1.jpg" alt="Techno-Management" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
                 <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
               </div>
               <div className="p-8 flex flex-col flex-1">
                 <h3 className="text-2xl font-black text-gray-900 mb-4 leading-snug">Techno-Management Entrepreneurship Training</h3>
                 <span className="text-[#fbc02d] font-bold text-xs uppercase tracking-widest mb-4 inline-block">Structures, BIM & PM</span>
                 <p className="text-gray-600 font-medium leading-relaxed mb-8 flex-1">
                   Perfect for aspiring professionals looking to excel and lead in the construction industry.
                 </p>
                 <button className="self-start text-blue-600 font-black uppercase tracking-widest text-sm hover:text-blue-800 transition flex items-center gap-2 group-hover:gap-4 mt-auto">
                   Read More <span className="text-lg">→</span>
                 </button>
            ...
            <div className="bg-white rounded-[24px] shadow-[0_15px_40px_rgba(0,0,0,0.08)] overflow-hidden border border-gray-100 flex flex-col group hover:-translate-y-2 transition-transform duration-500 h-full">
               <div className="h-60 overflow-hidden relative">
                 <img src="/prj6.jpg" alt="Interior Designing" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
                 <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
               </div>
               <div className="p-8 flex flex-col flex-1">
                 ...
                 <div className="flex items-center gap-2 mb-8">
                   <div className="flex text-amber-400">
                     {'★'.repeat(4)}<span className="text-amber-400">★</span>
                   </div>
                   <span className="font-bold text-gray-900 text-lg">4.6</span>
                   <span className="text-gray-500 font-medium text-sm">(9,678 reviews)</span>
                 </div>
                 <button className="self-start text-blue-600 font-black uppercase tracking-widest text-sm hover:text-blue-800 transition flex items-center gap-2 group-hover:gap-4 mt-auto">
                   Read More <span className="text-lg">→</span>
                 </button>
        ...
        <div className="max-w-[1000px] mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 font-medium text-lg leading-relaxed max-w-2xl mx-auto">
              Find answers to common questions about our Master Study in Project Management with BIM Engineering program
            </p>
            <div className="w-24 h-[4px] bg-[#fbc02d] mx-auto rounded-full mt-6"></div>
          </div>
            ...
            {faqs.map((faq, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div 
                    className={`transition-all duration-500 ease-in-out overflow-hidden ${isActive ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'}`}
                  >
                    <div className="px-6 md:px-8 pb-8 pt-0 text-gray-600 font-medium text-lg leading-relaxed">
                      {faq.answer}
                    </div>
                  </div>
                </div>
