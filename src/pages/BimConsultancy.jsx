...
const SECTOR_IMAGES = [S1, S2, S3, S4, S5, S6];
const DIM_ICONS = [PenTool, Box, Calendar, DollarSign, Leaf, Settings, ShieldAlert, TrendingUp, Layers];
...
const BimConsultancy = () => {
  ...
  const howToGetStarted = bim.howToGetStarted || [];
  const WHY_ICONS = [
    <Users size={32} />,
    <MonitorPlay size={32} />,
    <Award size={32} />,
      ...
      <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-black pt-20 pb-12">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
          ...
          <motion.a
            ...
            onClick={(e) => {
              e.stopPropagation();
              window.open('https://econstructinternational-my.sharepoint.com/:b:/g/personal/pranjal_wawdhane_e-construct_org/IQBRnE9Asb0aS7qq8yX50plvASFisAvU7rUlsNgwOST0VmE?e=gZnr5t', '_blank', 'noopener,noreferrer');
            }}
          ...
          <div className="grid lg:grid-cols-2 gap-20">
            ...
            <div className="bg-white/5 p-10 md:p-14 rounded-[3rem] border border-white/10 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-2 gap-10">
                {bim.impactMetrics.map((metric, idx) => (
