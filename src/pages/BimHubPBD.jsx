...
const BimHubPBD = () => {
  ...
  const faqs = [
    ...
    { q: 'What certification will I receive?', a: 'Experience letter (12 months), Performance Based Design Certification from Econstruct, portfolio assistance, video resume assistance, and LinkedIn photoshoot.' },
    ...
    <div className="bg-white overflow-x-hidden">
      ...
      <section className="relative w-full min-h-[100dvh] lg:h-[700px] overflow-hidden bg-black">
        <div className="absolute inset-0 scale-105">
          <img src="/prj8.jpg" alt="" className="w-full h-full object-cover brightness-[0.45] saturate-[0.8]" />
        ...
        <div className="relative z-10 h-[100dvh] lg:h-full w-full max-w-[1400px] px-5 sm:px-10 flex flex-col justify-end pb-16 lg:pb-20">
          <motion.div initial="i" animate="a" variants={{ a: { transition: { staggerChildren: 0.1 } } }} className="lg:max-w-4xl">
            ...
            <motion.p variants={{ i: { opacity: 0, y: 20 }, a: { opacity: 1, y: 0, transition: { duration: 0.7 } } }}
              ...
              Advanced structural design using performance-based methodologies — on real live projects.
            </motion.p>
        ...
        <div className="max-w-[1400px] mx-auto px-5 sm:px-10">
          <motion.div {...fin} className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-medium text-black tracking-tight">
                See What <span className="accent-text italic">PBD</span> Is About
              </h2>
            </div>
            <p className="text-gray-400 text-sm max-w-xs sm:text-right leading-relaxed">
              Performance Based Design — advanced seismic and structural analysis.
            </p>
          </motion.div>
          <motion.div {...fin} className="relative w-full bg-black aspect-video overflow-hidden shadow-[0_20px_60px_-10px_rgba(0,0,0,0.3)]">
            ...
            <iframe src="https://www.youtube.com/embed/YkimCw_Nu1M?si=TMB-qf3YXr24j9-r"
              className="absolute inset-0 w-full h-full" title="PBD Video" frameBorder="0"
            ...
            <div className="flex flex-col gap-px bg-gray-200">
              <motion.div {...fin} className="bg-white p-8 md:p-10 flex-1">
                ...
                <p className="text-black font-medium text-xl tracking-tight mb-5">
                  Master <span className="accent-text italic">12 structural tools</span> on real projects
                </p>
                <div className="flex flex-wrap gap-2">
                  {softwares.map((s, i) => (
                    <span key={i} className={`px-3 py-1.5 text-xs font-semibold border ${i < 6 ? 'bg-yellow-500 border-yellow-500 text-black' : 'border-gray-200 text-gray-600'}`}>{s}</span>
                  ))}
                </div>
              </motion.div>
              <motion.div {...fin} className="bg-yellow-500 p-8 md:p-10">
                ...
                <div className="space-y-2">
                  {['Experience Letter (12 months)', 'Portfolio assistance', 'LinkedIn photoshoot', '100% Placement Guarantee'].map(item => (
        ...
        <div className="max-w-[1400px] mx-auto px-5 sm:px-10">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
            <motion.div {...fin} className="lg:w-2/5 shrink-0 lg:sticky lg:top-28 self-start">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">Common questions about the Performance Based Design program.</p>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0">
          <img src="/prj8.jpg" alt="" className="w-full h-full object-cover brightness-[0.35] saturate-[0.6]" />
