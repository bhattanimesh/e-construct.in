...
const DEFAULT_DATA = {
  ...
  blogs: [
    { id: 1, title: "Transforming a Barren Pond Area", desc: "Transforming a Barren Pond Area into a thriving green space.", img: "/b1_new.jpg" },
    { id: 2, title: "The Evolution of Modern-Day Construction", desc: "The Evolution of Modern-Day Construction and how technology is reshaping the industry.", img: "/b2_new.png" },
    { id: 3, title: "Why Buildings Crack and How to Fix Them", desc: "Cracks in buildings are a common concern. Learn the causes and solutions.", img: "/b3_new.png" },
    { id: 4, title: "Top 10 Benefits of BIM", desc: "Top 10 Benefits of BIM for construction projects of all scales.", img: "/b1_new.jpg" },
    { id: 5, title: "The Kolkata Flyover Collapse", desc: "The tragic collapse of the Kolkata flyover and lessons learned.", img: "/b2_new.png" },
    { id: 6, title: "Building Collapses in India", desc: "Discover the causes of building collapses and how to prevent them.", img: "/b3_new.png" },
    { id: 7, title: "Decline in vision for Temples of heritage", desc: "Old temple architecture is a testament to the ingenuity and artistry of ancient builders.", img: "/b1_new.jpg" },
    { id: 8, title: "What's wrong with the making process of a Civil Engineer?", desc: "Civil Engineering is a part of engineering that deals with mathematical and scientific knowledge.", img: "/b2_new.png" },
    { id: 9, title: "Tips to get a job as a Structural Engineer", desc: "As a fresher, it is always difficult as a Structural Engineer. Most companies prefer experienced candidates.", img: "/b3_new.png" },
  ],
  team: [
...
const DATA_VERSION = 5; // bump this when defaults change to force a migration
